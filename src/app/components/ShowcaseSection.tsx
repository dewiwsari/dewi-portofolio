...
const PROJECTS: CardItem[] = [
  {
    ...
    technologies: ["Flutter", "Dart", "Firebase", "Firestore", "Hive", "Figma"],
    achievements: ["Selected for IPB Innovation Showcase 2024", "500+ beta test users"],
  },
  {
    id: "cms-extracurricular",
    title: "Extracurricular CMS",
    subtitle: "Content Management System — Web App",
    ...
    technologies: ["React", "TypeScript", "Laravel", "MySQL", "Tailwind CSS", "Pusher"],
  },
  {
    id: "edenia-florist",
    title: "Edenia Florist App",
    ...
    responsibilities: [
      "Flutter UI with custom animations & transitions",
      "Node.js REST API with JWT authentication",
      "MongoDB schema design & query optimization",
      "Payment gateway integration (Midtrans)",
    ],
    technologies: ["Flutter", "Node.js", "MongoDB", "Firebase", "Figma"],
  },
  {
    id: "ai-food-rec",
    ...
    period: "2026",
    tags: ["Flutter", "Python", "FastAPI", "ML"],
    images: [
    ...
    technologies: ["Flutter", "Python", "FastAPI", "Scikit-learn", "Pandas", "PostgreSQL"],
...
const WORK: CardItem[] = [
  {
    ...
    links: { view: "#" },
    overview: "Contributed to enterprise backend development at Indonesia's leading telecommunications technology subsidiary.",
    responsibilities: [
      "Built & maintained RESTful APIs with Spring Boot",
      "Optimized SQL queries — cut report generation by 40%",
  ...
  },
  {
    ...
    subtitle: "IPB University — Programming Courses",
    period: "2024–2025",
    tags: ["Python", "Java", "Education"],
    images: [
      "https://images.unsplash.com/photo-1580894908361-967195033215?w=640&h=400&fit=crop&auto=format",
    ],
    links: { view: "#" },
    overview: "Assisted professors in delivering programming fundamentals and OOP courses to 200+ undergrad students.",
    responsibilities: [
      "Led weekly lab sessions for 30+ students",
      "Created & graded programming assignments",
      "1-on-1 tutoring and debugging support",
    ],
    technologies: ["Python", "Java", "Jupyter Notebook"],
  },
  {
    id: "coding-instructor",
    title: "Coding & Robotics Instructor",
    subtitle: "Gerakan Mengajar Desa",
    period: "2023–2024",
    tags: ["Scratch", "Arduino", "STEM"],
    images: [
      "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=640&h=400&fit=crop&auto=format",
    ],
    links: { view: "#" },
    overview: "Taught coding & robotics to elementary and middle school students in rural West Java as part of a national education initiative.",
    responsibilities: [
      "Designed age-appropriate curriculum for 50+ students",
      "Led hands-on Arduino robotics workshops",
      "Created Scratch visual programming lessons",
    ],
    technologies: ["Scratch", "Arduino", "Tinkercad"],
  },
];
...
const ORGS: CardItem[] = [
  {
    ...
    role: "Division Head — Software Development",
    period: "2023–2025",
    tags: ["Leadership", "Software Dev"],
    images: [
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=640&h=400&fit=crop&auto=format",
    ],
    links: { view: "#" },
    overview: "Led the software development division, overseeing projects and workshops for IPB's largest tech org.",
    responsibilities: [
      "Managed team of 15 developers",
      "Organized hackathons for 200+ participants",
      "Mentored juniors on industry best practices",
    ],
  },
  {
    id: "gmd",
    title: "Gerakan Mengajar Desa",
    subtitle: "Technology & Education Coordinator",
    period: "2023–2024",
    ...
    links: { view: "#" },
    overview: "Coordinated tech education programs bringing digital literacy and coding to underserved rural communities across West Java.",
    responsibilities: [
      "Deployed volunteers to 5 villages",
      "Developed basic digital literacy curriculum",
      "Impacted 300+ students across rural schools",
    ],
  },
  {
    id: "kominfo",
    title: "KOMINFO TRPL",
    subtitle: "Software Engineering Technology Student Association",
    ...
    links: { view: "#" },
    overview: "Led communications & digital marketing for the SE student association — social media, events, and publications.",
    responsibilities: [
      "Grew social media presence 150% in one year",
      "Designed promotional materials & event branding",
      "Coordinated annual tech symposium for 500+ attendees",
    ],
  },
];
...
const COMPETITIONS: CardItem[] = [
  {
    ...
    achievements: ["Top 10 / 200+ teams nationwide", "Presented to industry judges panel"],
  },
  {
    id: "secomp",
    title: "SECOMP 2025",
